...
const Popups = {
    ...
    NOT_ALLOWED_SPECIAL_CHARACTERS: ["The following character(s) cannot be used:", "　"],
    NOT_ALLOWED_SPECIAL_SYMBOLS: ["You cannot have two or more of", "the following character(s) in a row:", "　"],
