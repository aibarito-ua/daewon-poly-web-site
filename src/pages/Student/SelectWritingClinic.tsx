    ...
    return (
        <section className="section-common-layout" >
            <div className="flex flex-1 max-sm:flex-col sm:px-[10%] gap-[5%] w-screen min-h-full justify-center text-center align-middle">
                <Button className="select-writing-item-button" onClick={()=>CommonFunctions.goLink( 'WritingClinic/SparkWriting', navigate, role)}><span className="text-3xl">{'Spark Writing'}</span></Button>
